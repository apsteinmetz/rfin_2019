...
NOTE: This is not a trading strategy.  It is an analysis of fundamental portfolio properties.
As such we are not concerned with transaction costs or specific securities.  The question we will answer is akin to the question "What does adding bonds do to the risk and reward of a stock index portfolio?" Transaction costs are not that relevant to the question.  In practice, rolling Treasury futures or interest-rate swaps would entail ongoing trading costs but these are highly liquid markets with de-minimus bid-offer spreads.
